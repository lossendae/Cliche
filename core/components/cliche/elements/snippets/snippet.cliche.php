...
$scriptProperties['plugin'] = $modx->getOption('plugin', $scriptProperties, 'defaultPlugin');
$scriptProperties['chunk_dirname'] = $modx->getOption('chunk_dirname', $scriptProperties, 'default');
